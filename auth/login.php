...
<head>
    ...
    <!-- Favicons -->
    <link rel="apple-touch-icon" sizes="144x144" href="<?php echo BASE_URL?>assets/images/logo/logo-icon.png">
    <link rel="shortcut icon" href="<?php echo BASE_URL?>assets/favicon.ico">
    <meta name="theme-color" content="#3063A0"><!-- Google font -->
    <link href="https://fonts.googleapis.com/css?family=Fira+Sans:400,500,600" rel="stylesheet"><!-- End Google font -->
    <!-- BEGIN PLUGINS STYLES -->
    <link rel="stylesheet" href="<?php echo BASE_URL?>assets/vendor/%40fortawesome/fontawesome-free/css/all.min.css"><!-- END PLUGINS STYLES -->
    <!-- BEGIN THEME STYLES -->
  ...
  <body>
    ...
    <main class="auth">
      <header id="auth-header" class="auth-header" style="background-image: url(assets/images/illustration/img-1.png);">
        <h1>
          <img src="<?php echo BASE_URL?>assets/images/logo/logo-white.png" alt="" height='80'>
           <span class="sr-only">Sign In</span>
        </h1>
<br>
        
      </header><!-- form -->
      <form class="auth-form" method='post' id='frmLogin' action='../'>
        <!-- .form-group -->
    ...
    <!-- BEGIN THEME JS -->
    <script src="<?php echo BASE_URL?>assets/javascript/theme.js"></script> <!-- END THEME JS -->
