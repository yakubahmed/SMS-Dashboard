...
<?php $title = "Expense Head"; include_once(ROOT_PATH. '/includes/header.php'); ?>
      <!-- .app-header -->
            ...
            <div class="page-inner">
              ...
              <div class="page-section">
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-header bg-info text-light"> Add new income type  </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label for="">Income type name</label>
                                        <input type="text" name="" id="" class="form-control" placeholder='Income name'>
                                    </div>
                                    <div class="form-group col-md-12">
